...
- eopkg
  - If you're refering to the application or package, use "`eopkg`" with inline code formatting (see below)
  - If you're refering to package files, use "`.eopkg`" with inline code formatting, including the period but no wildcard
