...
As of March 27, 2026, our firewalld package is [Stateless](/docs/user/software/configuration_files). These are the default configuration file locations for firewalld:
